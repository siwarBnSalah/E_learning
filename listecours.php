...
function checkDelete(){
    return confirm('Voulez vous vraiment supprimer cet Matiere ?');
}
</script>
...
<?php 
 ...
 $query = ' SELECT * FROM  `cours` ORDER BY id_cour DESC ';
...
<div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Gérer <b>Matiere</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Ajouter un nouvel Matiere</span></a>
...
<table  width="100%"cellspacing="0" border="2">
 ...
 <td><form method="POST" action="voirpdf.php"><input type="submit" name="voirpdf" value="voir pdf"></form></td>
 
 <td>
 
 <?php  echo"<button class='btn btn-warning' ><a  style='color:#FFFFFF' href='updateCour.php?updateid=".$row['id_cour']." '   class='mr-3' data-toggle='tooltip' ><span class='fa fa-pencil' ></span></a></button>" ;?>
 <?php  echo"<button class='btn btn-warning' ><a  style='color:#FFFFFF' href='deleteCour.php?deleteid=".$row['id_cour']." '   class='mr-3' data-toggle='tooltip'  onclick='return checkDelete()' ><span class='fa fa-trash' ></span></a></button>" ;?>
</td>
</form>
</td>
 ...
 ?>
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form name="f" method="POST" action="AjoutMat.php">
	...
	<div id="deleteEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form name="f2" method="POST" action="deleteTouMat.php">
					<div class="modal-header">						
						<h4 class="modal-title">supprimer tous les matiere</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">					
						<p>Voulez-vous vraiment supprimer ces Matiere?</p>
