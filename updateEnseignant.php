...
include('connexion.php');
    ...
    if (isset($_GET['updateid'])) {
       ...
       $sql="SELECT *FROM `enseignant` WHERE  ID='$idEn'";
...
<div class="container">
<form method="POST" action="update2Enseignant.php">
        <fieldset style="width: 500">
            ...
            <tr>
                    ...
                    <td><input type="text" name="idd" size="15" maxlength="30" value="<?php echo $idEn?>"hidden><br></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="nom" size="15" maxlength="30" value="<?php echo $name?>" required><br></td>&thinsp;
                ...
                <tr>
                    <td>
                        ...
                        <td><input type="text" name="cin" size="15" maxlength="30" value="<?php echo $cin?>" required><br></td>
                    </td>
