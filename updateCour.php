...
include('connexion.php');
    ...
    if (isset($_GET['updateid'])) {
       ...
       $sql="SELECT *FROM `cours` WHERE  id_cour='$idcou'";
...
<div class="container">
<form method="POST"  enctype="multipart/form-data"  action="update2cours.php">
        <fieldset style="width: 500">
            ...
            <tr>
                    ...
                    <td><input type="text" name="idd" size="15" maxlength="30" value="<?php echo $idcou?>"hidden><br></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="description" size="50" maxlength="50"  value="<?php echo $description?>"required><br></td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <td><input type="file" name="file" size="15" maxlength="30" value="<?php echo  $file?>" required><br></td>
                    </td>
